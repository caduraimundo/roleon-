...
export default function PortariaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{
      ...
      {loading && (
        <div style={{ textAlign: 'center', padding: '32px 16px', color: '#9A9A9A', fontSize: 14 }}>Carregando...</div>
      )}

      {loadError && (
        <div style={{ textAlign: 'center', padding: '32px 16px' }}>
          <p style={{ color: '#FF3B30', fontSize: 14, marginBottom: 12 }}>Nao foi possivel carregar os dados da portaria. Verifique sua conexao.</p>
