    ...
    <div style={{ width: '100%', maxWidth: 480, margin: '0 auto', flex: 1,
      ...
      <div style={{ flex: 1, padding: '28px 20px 108px', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
          ...
          {/* Nome */}
          <div style={{ fontSize: 20, fontWeight: 700, color: '#1A1A1A', letterSpacing: -0.3, textAlign: 'center' }}>
            {name}
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          {role === 'admin' ? (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 15, fontWeight: 700, color: '#0A7A76', letterSpacing: -0.2 }}>Painel Admin</div>
                <div style={{ fontSize: 13, color: '#4AA8A4', marginTop: 2, fontWeight: 500 }}>Gerenciar o Roleon</div>
              </div>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
