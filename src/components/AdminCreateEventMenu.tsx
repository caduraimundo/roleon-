...
interface AdminCreateEventMenuProps {
  open: boolean
  onClose: () => void
}
...
export default function AdminCreateEventMenu({ open, onClose }: AdminCreateEventMenuProps) {
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: '0 20px 28px', display: 'flex', flexDirection: 'column', gap: 10 }}>
          <OptionRow
            ...
            onClick={() => { onClose(); router.push('/admin/eventos/novo') }}
            icon={
          ...
          <OptionRow
            ...
            onClick={() => { onClose(); router.push('/admin/series/novo') }}
            icon={
              <svg width="20" height="20" viewBox="0 0 22 22" fill="none">
